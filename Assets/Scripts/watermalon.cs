...
public class watermalon : MonoBehaviour
{
  [SerializeField]
    private Transform watermalonPlace;
  ...
  private bool Dragging =false;
    ...
    void Update()
    {
        ...
        switch (touch.phase)
        {
            ...
            {
                transform.position = new Vector2(watermalonPlace.position.x,watermalonPlace.position.y);
                locked=true;
