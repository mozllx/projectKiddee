...
public class trash3 : MonoBehaviour
{
   [SerializeField]
  ...
  private bool Dragging =false;
    ...
    void Update()
    {
        ...
        switch (touch.phase)
        {
            ...
            if(Mathf.Abs(transform.position.x-trashPlace.position.x)<=0.5f&&
               Mathf.Abs(transform.position.y-trashPlace.position.y)<=0.5f)
            {
